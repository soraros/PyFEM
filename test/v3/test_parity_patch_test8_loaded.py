...
"""Parity: v3 linear solve vs legacy on PatchTest8 with nodal load."""
...
SKIM_DIR = ROOT / "skims" / "patch_test8_loaded"
...
def test_parity_loaded_from_problem_toml(tolerances: tuple[float, float]) -> None:
...
def test_parity_loaded_from_skim_pro(tolerances: tuple[float, float]) -> None:
  rtol, atol = tolerances
