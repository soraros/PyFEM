...
| FEM math | `fem/quadrature.py`, `fem/shapes.py`, `fem/kinematics.py`, `fem/element.py` | Vectorized Gauss rules, N, B, K_e = ∫ Bᵀ C B |
| Assembly | `fem/assembly.py` | Batched `einsum` + vectorized COO scatter |
